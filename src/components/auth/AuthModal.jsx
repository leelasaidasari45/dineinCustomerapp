  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (mode === 'login') {
        ...
        toast.success(form.role === 'restaurant_owner' ? 'Restaurant Owner account created! Welcome to Zuno 🍽️' : 'Account created! Welcome to Zuno 🍽️');
        closeAuthModal();
      }
    } catch (err) {
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <button
                            type="button"
                            onClick={() => setForm(f => ({ ...f, role: 'restaurant_owner' }))}
                            className={`py-2 px-3 rounded-xl border text-sm font-semibold transition-all ${
