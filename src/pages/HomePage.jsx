        ...
        <div className="relative bg-gradient-to-br from-dark-800 via-dark-700 to-amber-900/40 pt-28 pb-16 px-4">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500/10 to-teal-600/10 border border-emerald-500/35 rounded-full px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-emerald-400 shadow-[0_0_12px_rgba(16,185,129,0.08)] hover:shadow-[0_0_20px_rgba(16,185,129,0.18)] hover:border-emerald-400 transition-all duration-300 mb-6 cursor-default select-none backdrop-blur-sm"
            >
              <motion.span
                animate={{ scale: [1, 1.25, 1], filter: ['drop-shadow(0 0 1px rgba(16,185,129,0.5))', 'drop-shadow(0 0 4px rgba(16,185,129,0.8))', 'drop-shadow(0 0 1px rgba(16,185,129,0.5))'] }}
